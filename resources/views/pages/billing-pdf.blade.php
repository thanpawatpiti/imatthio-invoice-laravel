            ...
            <div class="col-12">
                    ...
                    <tr>
                        ...
                        <td style="width: 50%; text-align: center;">
                            @if($bill->headers->logo)
                                <img src="{{ asset('images/' . $bill->headers->logo) }}" alt="Logo" style="width: 100px; height: 100px;">
                            @endif
                        </td>
                ...
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td style="width: 50%; text-align: center;">
                            @if($bill->headers->logo)
                                <img src="{{ asset('images/' . $bill->headers->logo) }}" alt="Logo" style="width: 80px; height: 80px;">
                            @endif
                        </td>
                    </tr>
                </table>
